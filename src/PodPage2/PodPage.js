    ...
    return (
        <div style={{ minHeight: "500px" }}>
            <div style={{ marginTop: "200px" }}>
                ...
                >CEBC MENA</a> · <a href="https://soundcloud.com/user-404118386/season-2-ep1-electric-vehicles-in-mena-everything-you-need-to-know" title="S2: Ep. 1: Electric Vehicles in MENA: Everything you need to know." target="_blank"
                    style={{ color: "#cccccc", textDecoration: "none" }}
                >S2: Ep. 1: Electric Vehicles in MENA: Everything you need to know.</a></div>
